...
using SchoolMastery.Properties;
...
namespace SchoolMastery.Model
{
    public class TestBuilder
    {
        ...
        private static string folderName = Path.GetFullPath(@"Tests/");
        ...
        public static Test createTest(string fileName)
        {
            try
            {
                MemoryStream mr = GenerateStreamFromString(fileName);
                StreamReader sr = new StreamReader(mr);
